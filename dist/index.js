...
function action(context = github.context) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const octokit = new github.GitHub(GITHUB_TOKEN, { baseUrl: "https://github.boschdevcloud.com/api/v3" });
            ...
            const config = yield config_1.default(octokit, configPath, context.repo, ref, defaultConfig);
